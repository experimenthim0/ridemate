    ...
    <nav className="bg-auto-black text-white sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2 no-underline">
          <span className="text-3xl"><img src="/icons8-auto-rickshaw-94.png" alt="" className="w-10 h-10"/></span>
        ...
        <div className="flex items-center gap-4">
          {!user ? (
            <>
              <Link
                to="/student-login"
                className="text-gray-300 hover:text-primary transition-colors text-sm font-medium no-underline bg-neutral-700 px-2 py-1 rounded-lg"
              >
